						...
						<div class="col-lg-8 col-xl-8">
							...
							<div class="recent-news blog-lg">
								<div class="action-box blog-lg">
									<img src="assets/images/blog/1558260985178.png" alt="">
								</div>
								<div class="info-bx">

									<ul class="media-post">
										<li><a href="#"><i class="fa fa-calendar"></i>Sept 10 2024</a></li>
										<li><a href="#"><i class="fa fa-comments-o"></i>10 Comment</a></li>
									</ul>
									<h5 class="post-title">Data Science V/s Software Developer</h5>
									<p>Software Developers and Data Scientists are both pivotal roles in the tech world but differ in their focus and skill sets. Software Developers are responsible for creating, designing, and maintaining applications or systems. They use programming languages like Java, Python, or JavaScript to build functional, user-friendly software and collaborate closely with other developers and designers to solve technical problems. On the other hand, Data Scientists focus on analyzing large datasets, using statistical techniques and machine learning algorithms to uncover patterns, trends, and actionable insights. Their expertise in tools like Python, R, and data visualization platforms helps companies make data-driven decisions. While developers are involved in building the software solutions people use, data scientists leverage data to optimize operations and strategies. Choosing between these careers depends on whether you're more passionate about building software systems or digging deep into data to find valuable insights.</p>
...
$DB_SERVER = "localhost"; // Replace with your server name
$DB_USERNAME = "root"; // Replace with your database username
$DB_PASSWORD = ""; // Replace with your database password
$DB_DATABASE = "admin"; // Replace with your database name
...
$sql = "SELECT * FROM blogs"; // Adjust the query based on your table structure
...
<div class="info-bx">
    <ul class="media-post">
        <li><a href="#"><i class="fa fa-calendar"></i><?php echo date('M d Y', strtotime($row['created_at'])); ?></a></li>
        <li><a href="#"><i class="fa fa-comments-o"></i><?php echo $row['comment_count']; ?> Comment</a></li> <!-- Replace with dynamic comment count if needed -->
    </ul>
									...
									<div class="widget-post-bx">
										<div class="widget-post clearfix">
											...
											<div class="ttr-post-info">
												<div class="ttr-post-header">
													<h6 class="post-title"><a href="blog-details.html">Data Science VS Software Developer</a></h6>
												</div>
												<ul class="media-post">
													<li><a href="#"><i class="fa fa-calendar"></i>Oct 23 2023</a></li>
										...
										<div class="widget-post clearfix">
											...
											<div class="ttr-post-info">
												...
												<ul class="media-post">
													<li><a href="#"><i class="fa fa-calendar"></i>May 14 2023</a></li>
										...
										<div class="widget-post clearfix">
											...
											<div class="ttr-post-info">
												...
												<ul class="media-post">
													<li><a href="#"><i class="fa fa-calendar"></i>June 12 2023</a></li>
