		...
		<div class="ttr-header-wrapper">
			...
			<div class="ttr-header-right ttr-with-seperator">
				...
				<ul class="ttr-header-navigation">
					...
					<li>
						<a href="#" class="ttr-material-button ttr-submenu-toggle"><span class="ttr-user-avatar"><img alt="" src="assets/images/testimonials/pic5.png" width="32" height="32"></span></a>
						<div class="ttr-header-submenu">
							<ul>
								<!-- <li><a href="adminprofile.php">My profile</a></li> -->
								<!-- <li><a href="list-view-calendar.html">Activity</a></li> -->
								<li><a href="enquiry.php">Messages</a></li>
							...
							<div class="noti-box-list">
								<ul>
									...
									<li>
										...
										<span class="notification-text">
											<a href="#">Ritu applied </a> sent you a message.
										</span>
										<span class="notification-time">
											<a href="#" class="fa fa-close"></a>
											<span> 7 Min</span>
									...
									<li>
										...
										<span class="notification-text">
											<span>Anushka registered</span> sent you a message.
										</span>
										<span class="notification-time">
											<a href="#" class="fa fa-close"></a>
											<span> 2 May</span>
									...
									<li>
										...
										<span class="notification-text">
											<a href="#">Sneha Contacted for query</a> sent you a message.
										</span>
										<span class="notification-time">
											<a href="#" class="fa fa-close"></a>
											<span> 14 July</span>
									...
									<li>
										...
										<span class="notification-text">
											<span>Neha new login </span> sent you a message.
										</span>
										<span class="notification-time">
											<a href="#" class="fa fa-close"></a>
											<span> 15 Min</span>
...
// Fetching the 10 most recent records from the database
$sql = "SELECT name, email FROM register ORDER BY id DESC LIMIT 10"; // Adjust with the correct column for ordering
$result = $conn->query($sql);

// Check if there are results and output them
if ($result->num_rows > 0) {
    echo '<div class="new-user-list">';
    echo '<ul>';
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo '<li>';
        echo '<span class="new-users-pic">';
        echo '<img src="assets/images/testimonials/pic4.png" alt=""/>'; // Replace with dynamic image path if available
        echo '</span>';
        echo '<span class="new-users-text">';
        echo '<a href="#" class="new-users-name">' . htmlspecialchars($row['name']) . '</a>';
		echo '<a href="#" class="new-users-name">' . htmlspecialchars($row['email']) . '</a>';
        echo '</span>';
        echo '<span class="new-users-btn">';
        echo '<a href="#" class="btn button-sm outline">Registered</a>';
        echo '</span>';
        echo '</li>';
    }
								...
								<ul>
									<li>
										...
										<span class="new-users-text">
											<a href="#" class="new-users-name">Anuradha Singh </a>
											<span class="new-users-info"> Student </span>
										</span>
									...
									<li>
										...
										<span class="new-users-text">
											<a href="#" class="new-users-name"> Milind gaba</a>
											<span class="new-users-info"> Student </span>
										</span>
										<span class="new-users-btn">
											<a href="#" class="btn button-sm outline">Follow</a>
