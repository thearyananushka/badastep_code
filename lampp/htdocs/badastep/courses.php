							...
							<div class="widget recent-posts-entry widget-courses">
                                ...
                                <div class="widget-post-bx">
                                    <div class="widget-post clearfix">
                                        ...
                                        <div class="ttr-post-info">
                                            <div class="ttr-post-header">
                                                <h6 class="post-title"><a href="Engineering.html">Engineering</a></h6>
                                            </div>
                                    ...
                                    <div class="widget-post clearfix">
                                        ...
                                        <div class="ttr-post-info">
                                            <div class="ttr-post-header">
                                                <h6 class="post-title"><a href="Management.html">Management</a></h6>
                                            </div>
                                            <div class="ttr-post-meta">
                                                <ul>
                                                    <!-- <li class="price">
							...
							<div class="row">
								<div class="col-md-6 col-lg-4 col-sm-6 m-b30">
									<div class="cours-bx">
										...
										<div class="info-bx text-center">
											<h5><a href="Engineering.html">Engineering</a></h5>
										...
										<div class="cours-more-info">
											...
											<div class="price">
												<h5><a href="applynow.php">Apply Now</a></h5>
											</div>
										</div>
									</div>
								</div>
								<div class="col-md-6 col-lg-4 col-sm-6 m-b30">
									<div class="cours-bx">
										...
										<div class="info-bx text-center">
											<h5><a href="Medical.html">Medical</a></h5>
									...
									<div class="cours-bx">
										<div class="cours-bx">
											<div class="action-box">
												...
												<a href="Management.html" class="btn">Read More</a>
											</div>
											<div class="info-bx text-center">
												<h5><a href="Management.html">Management</a></h5>
												<span>Emerging Profession</span>
											</div>
											<div class="cours-more-info">
												<div class="review">
													<span>5 Review</span>
								...
								<div class="col-md-6 col-lg-4 col-sm-6 m-b30">
									<div class="cours-bx">
										<div class="action-box">
											...
											<a href="Agriculture.html" class="btn">Read More</a>
										</div>
										<div class="info-bx text-center">
											<h5><a href="Agriculture.html">Agriculture</a></h5>
								...
								<div class="col-md-6 col-lg-4 col-sm-6 m-b30">
									<div class="cours-bx">
										<div class="action-box">
											...
											<a href="Pharmacy.html" class="btn">Read More</a>
										</div>
										<div class="info-bx text-center">
											<h5><a href="Pharmacy.html">Pharmacy</a></h5>
								...
								<div class="col-md-6 col-lg-4 col-sm-6 m-b30">
									<div class="cours-bx">
										<div class="action-box">
											...
											<a href="Paramedical.html" class="btn">Read More</a>
										</div>
										<div class="info-bx text-center">
											<h5><a href="Paramedical.html">Paramedical</a></h5>
								...
								<div class="col-md-6 col-lg-4 col-sm-6 m-b30">
									<div class="cours-bx">
										<div class="action-box">
											...
											<a href="Nursing.html" class="btn">Read More</a>
										</div>
										<div class="info-bx text-center">
											<h5><a href="Nursing.html">Nursing</a></h5>
											<span>Health Science</span>
										</div>
										<div class="cours-more-info">
											<div class="review">
								...
								<div class="col-md-6 col-lg-4 col-sm-6 m-b30">
									<div class="cours-bx">
										<div class="action-box">
											...
											<a href="Veterinary Science.html" class="btn">Read More</a>
										</div>
										<div class="info-bx text-center">
											<h5><a href="Veterinary Science.html">Veterinary Science</a></h5>
											<span>Life Science</span>
										</div>
										<div class="cours-more-info">
											<div class="review">
								...
								<div class="col-md-6 col-lg-4 col-sm-6 m-b30">
									<div class="cours-bx">
										<div class="action-box">
											...
											<a href="Fire and safety.html" class="btn">Read More</a>
										</div>
										<div class="info-bx text-center">
											<h5><a href="Fisheries Science.html">Fisheries Science</a></h5>
								...
								<div class="col-lg-12 m-b20">
									<div class="pagination-bx rounded-sm gray clearfix">
										<ul class="pagination">
											<li class="previous"><a href="courses.php"><i class="ti-arrow-left"></i> Prev</a></li>
											<li class="active"><a href="courses.php">1</a></li>
											<li><a href="courses1.php">2</a></li>
											<li><a href="courses2.php">3</a></li>
											<li class="next"><a href="courses1.php">Next <i class="ti-arrow-right"></i></a></li>
										</ul>
									</div>
								</div>
							</div>
				...
				<div class="container">
					<div class="d-flex align-items-stretch">
						<div class="pt-logo mr-auto">
							<a href="index.php"><img src="assets/images/finallogo.png" alt=""/></a>
						</div>
